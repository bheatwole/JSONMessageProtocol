...
var constructor = function(maxMessageSize) {
	var self = {
	...
	var schemas = new JMP.SchemaCache(function(type, callback) { callback("Unknown message type"); });
	
	// Set up the message handler
	var handler = new JMP.MessageHandler({
		'router': handleRoute,
		'fetchSchema': schemas.get,
	...
	// This public function registers a schema with the server.
	self.registerSchema = function(type, schema) {
